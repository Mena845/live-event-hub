...
export const sessions = sessionsRaw.map((s, i) => ({
  ...s,
  id: `s${i + 1}`,
  eventId: "ev1",
}));
...
export const questions = [
  ...
  { id: "q2", sessionId: "s4", content: "Comment gérez-vous le code-switching français/malgache ?", authorName: "Tahina", upvotes: 7, createdAt: iso(addMin(now, -7)) },
  ...
  { id: "q5", sessionId: "s5", content: "Comment convaincre les équipes produit d'adopter le DS ?", authorName: "Lova", upvotes: 4, createdAt: iso(addMin(now, -2)) },
];
